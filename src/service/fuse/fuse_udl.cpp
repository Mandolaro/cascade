...
#define MY_UUID     "48e60f7c-8500-11eb-8755-0242ac110022"
#define MY_DESC     "FUSE UDL that printing what ever received on console."
...
class ConsolePrinterOCDPO: public OffCriticalDataPathObserver {
    virtual void operator () (const derecho::node_id_t sender,
        ...
        std::cout << "[fuse console printer ocdpo]: I(" << worker_id << ") received an object from sender:" << sender << " with key=" << key_string 
